...
class Brats2018Dataset(Dataset):
    """
        Brats2018 task 1 dataset is the segmentation corpus of the data. This dataset class performs dataloading
    ...
    def __init__(self, root_dir: str, is_train: bool = True, transform=None):
        """
        root_dir: path to (BraTS2018_Training_Data) folder
        ...
        if is_train:
            ...
            csv_fp = os.path.join(root_dir, "val_data.csv")
